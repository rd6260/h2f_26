  ...
  return (
    ...
    >
      <motion.div
        ...
        className="absolute inset-x-0 inset-y-0 z-0 h-full w-full bg-[url('https://cdn.jsdelivr.net/gh/rd6260/h2f_26@main/public/bg.webp')] bg-cover bg-center bg-no-repeat"
      />
      ...
      >
        <Image
          src="https://cdn.jsdelivr.net/gh/rd6260/h2f_26@main/public/hero1.webp"
          alt="Hero Graphic"
          width={1000}
          height={1000}
