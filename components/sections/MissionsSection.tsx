...
export default function MissionsSection() {
    ...
    const activeBtn =
        "filter-btn px-5 py-2.5 rounded-full text-sm font-medium transition-all duration-300 flex items-center gap-2 bg-white text-neutral-950 shadow-lg shadow-white/5 scale-105";
    const inactiveBtn =
        "filter-btn px-5 py-2.5 rounded-full text-sm font-medium transition-all duration-300 flex items-center gap-2 text-white/50 hover:text-white hover:bg-white/5";
        ...
        >
            ...
            <div className="md:px-12 z-10 w-full max-w-7xl mr-auto ml-auto pr-6 pl-6 relative">
                ...
                <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
                    ...
                    {/* Filter Controls */}
                    <AnimateOnScroll delay="delay-100" className="relative group">
                        ...
                        <div className="relative flex items-center p-1.5 rounded-full bg-neutral-900/90 border border-white/10 backdrop-blur-xl shadow-2xl">
                            {FILTER_BUTTONS.map((btn) => (
                                <button
                                    ...
                                    className={filter === btn.id ? activeBtn : inactiveBtn}
                                >
                                    {btn.icon}
                                    {btn.label}
                                </button>
                ...
                {/* Dynamic Grid */}
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 h-auto md:h-[800px] transition-all duration-500 ease-[cubic-bezier(0.25,1,0.5,1)]">
                    {/* Card 1: Ares Heavy */}
                    {showAres && (
